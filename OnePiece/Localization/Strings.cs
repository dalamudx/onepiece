...
public class Strings
{
    ...
    private static void InitializeTranslations()
    {
        ...
        var de = new Dictionary<string, string>
        {
            ...
            { "AddPlayerName", "Spielernamen hinzufügen" },
            { "AddCoordinates", "Koordinaten hinzufügen" },
            { "AddCustomMessage", "Benutzerdefinierte Nachricht hinzufügen:" },
        ...
        var fr = new Dictionary<string, string>
        {
            ...
            { "AddPlayerName", "Ajouter le nom du joueur" },
            { "AddCoordinates", "Ajouter des coordonnées" },
            { "AddCustomMessage", "Ajouter un message personnalisé:" },
